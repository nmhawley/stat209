...
**Answer**: This means that 17% of crimes in this year resulted in an arrest.
...
**Answer**: This means that 28% of crimes were classified as a theft.
...
**Answer**: This means that for every 1000 households, about 37 crimes were committed.
...
**Answer**: This is larger than the mean of the entire dataset. We can compare these measurements because they depend on proportions. This average is larger because there were proportionally more crimes that resulted in an arrests, so there were more 1s, leading to a higher average.
...
**Answer**: This is smaller than the mean of the entire dataset. Again, we can compare this to the whole dataset's mean because it is an average. This measurement is smaller because there were proportionally less crimes classified as arrests, so there were less 1s, leading to a lower average.
...
**Answer**: This value is larger than the overall value. We can compare them because we are only looking at both the crimes and ouseholds in this specific area.
...
**Answer**: Overall, as median income increases, the theft rate decreases. However, there is one area that has a median income over 60,000 dollars, but also has the highest theft rate.
...
**Answer**: The Loop is a tourist area, and tourists are very prone to theft.
