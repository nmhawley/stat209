...
**Answer**: Yes, this mean is 56938, and the mean in question 2 rounds up to the same value.
...
**Answer**: No, the highest number of salaries are higher than the given range. The salaries lower than the mean are less concentrated but have a greater range.
...
Yes, this range intersects the range of all teachers salaries.
...
**Answer**: This means that 80 times out of 100 the mean victim age should fall between 33.07 and 34.65.
